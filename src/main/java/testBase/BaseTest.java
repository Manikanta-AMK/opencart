...
//	}
	...
	public void extentReportMethod() {
		sparkReporter = new ExtentSparkReporter(System.getProperty("user.dir") + "/ExtentReports/Extentreport.html");
	...
	public void setupDriver(String browserName, Method testmethod) throws Throwable
	{
		flib = new filelib();
		...
		} else if (browserName.equalsIgnoreCase(flib.readpropertydata("browser","firefox"))) {
			WebDriverManager.firefoxdriver().setup();
			driver = new FirefoxDriver();
			log.info("Firefox browser opened");
		} else if (browserName.equalsIgnoreCase(flib.readpropertydata("browser","edge"))) {
